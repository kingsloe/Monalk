...
SECRET_KEY = '9aqddqmj+#wu@8s8kqd8j)au70yw8=#0xk5ym@_h^#u(i#!&lo'
...
if DEBUG == True:
    ...
    ALLOWED_HOSTS = ['monalk.site', 'www.monalk.site',
                     'monalk.online', 'www.monalk.online']
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.mysql',
            'NAME': 'monalksi2_monalkdb',
            'HOST': 'localhost',
            'PORT': 3306,
            'USER': 'monalksi2_admin',
            'PASSWORD': 'Sl7TM7jgw7Q6nzlfPQaOkH6d3A'
